...
/**
 * @author lsh
 * 	@date 2024. 7. 26. - 오후 3:43:15
 * @subject <? extends T> : 그놈과 그놈의 자식 타입은 다 받겠다.
 *	@content <? super T> : 그놈과 그놈의 부모 타입은 다 받겠다
 * 					<?> == <? extends Object> // ? : 와일드 카드 : 모든 타입을 다 받겠다.
 */
...
class Juicer{
	...
	// 위에 static 메서드(makeJuice)를 제네릭 메서드로 수정.
	// [제네릭 메서드]
	...
	//			}
	static <T extends Fruit> Juice makeJuice(FruitBox<T> box) { // 제네릭 메서드 위에 메서드랑 똑같음.
		return new Juice();
	}
